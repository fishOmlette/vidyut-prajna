...
def bootstrap_enhanced_demo() -> tuple:
    ...
    if ENHANCED_AVAILABLE and env_bool("USE_ENHANCED_SIM", True):
        ...
        print(f"      OK Enhanced simulation with gig fleet & OCPP data")
        ...
        ocpp_sessions, dtrs = [], []
        print(f"      OK Standard simulation")
    ...
    if ENHANCED_AVAILABLE and env_bool("USE_KDE", True):
        ...
        print(f"      OK Added KDE arrival rate predictions")
        print(f"      OK Added neighbor demand propagation")
    else:
    ...
    if ENHANCED_AVAILABLE and env_bool("USE_LAGRANGIAN", True):
        ...
        print(f"      OK Lagrangian MCDM optimization")
        print(f"      OK Iterations: {metrics.get('lagrangian_iterations', 'n/a')}")
        print(f"      OK Converged: {metrics.get('converged', 'n/a')}")
        ...
        print(f"      OK Greedy optimization")
    ...
    print(f"      OK Ranked {len(recommendations)} candidate locations")
