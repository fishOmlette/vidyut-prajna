...
def run_dashboard():
    """Run the Vidyut Prajna Dash dashboard."""
    from src.dashboard.app import run_server
    port = int(os.getenv("PORT", "8050"))
    debug = os.getenv("DEBUG", "true").lower() == "true"
    print(f"\nStarting Vidyut Prajna dashboard on http://127.0.0.1:{port}")
    print("Features: STGCN + Graph-TFT forecasting, Robust LP optimizer, Professional UI")
    run_server(debug=debug, port=port)


def run_simulation():
    """Generate and display simulation data with all features."""
    ...
    print("=" * 60)
    print("Generating Bengaluru Simulation Data")
    print("=" * 60)
